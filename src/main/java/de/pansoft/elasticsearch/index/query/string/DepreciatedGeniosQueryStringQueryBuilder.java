...
// FIXME:  This class should be removed later, if query-name is changed in all applications; check also org.xbib.elasticsearch.plugin.analysis.decompound.AnalysisDecompoundPlugin.getQueries

public class DepreciatedGeniosQueryStringQueryBuilder extends QueryStringQueryBuilder {
	...
	public DepreciatedGeniosQueryStringQueryBuilder(String queryString) throws IOException {
		super(queryString);
	}

	public DepreciatedGeniosQueryStringQueryBuilder(StreamInput in) throws IOException {
		super(in);
	}
