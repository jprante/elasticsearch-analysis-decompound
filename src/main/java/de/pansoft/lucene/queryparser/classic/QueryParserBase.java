...
public abstract class QueryParserBase extends QueryBuilder implements CommonQueryParserConfiguration {
    ...
    public abstract Query TopLevelQuery(String field) throws org.apache.lucene.queryparser.classic.ParseException;


    /** Parses a query string, returning a {@link org.apache.lucene.search.Query}.
     *  @param query  the query string to be parsed.
     *  @throws org.apache.lucene.queryparser.classic.ParseException if the parsing fails
     */
    public Query parse(String query) throws org.apache.lucene.queryparser.classic.ParseException {
        ...
        try {
            ...
            org.apache.lucene.queryparser.classic.ParseException e = new org.apache.lucene.queryparser.classic.ParseException("Cannot parse '" +query+ "': too many boolean clauses");
            e.initCause(tmc);
            throw e;
        }
    }
     ...
     * @exception org.apache.lucene.queryparser.classic.ParseException throw in overridden method to disallow
     */
    protected Query newFieldQuery(Analyzer analyzer, String field, String queryText, boolean quoted)  throws org.apache.lucene.queryparser.classic.ParseException {
    ...
    protected Query getRangeQuery(String field,
                                  ...
                                  boolean endInclusive) throws org.apache.lucene.queryparser.classic.ParseException
    {
     ...
     * @exception org.apache.lucene.queryparser.classic.ParseException throw in overridden method to disallow
     */
    protected Query getBooleanQuery(List<BooleanClause> clauses) throws org.apache.lucene.queryparser.classic.ParseException {
        if (clauses.size()==0) {
     ...
     * @exception org.apache.lucene.queryparser.classic.ParseException throw in overridden method to disallow
     */
    protected Query getWildcardQuery(String field, String termStr) throws org.apache.lucene.queryparser.classic.ParseException
    {
        if ("*".equals(field)) {
            if ("*".equals(termStr)) return newMatchAllDocsQuery();
        }
        if (!allowLeadingWildcard && (termStr.startsWith("*") || termStr.startsWith("?")))
            throw new org.apache.lucene.queryparser.classic.ParseException("'*' or '?' not allowed as first character in WildcardQuery");
     ...
     * @exception org.apache.lucene.queryparser.classic.ParseException throw in overridden method to disallow
     */
    protected Query getRegexpQuery(String field, String termStr) throws org.apache.lucene.queryparser.classic.ParseException
    {
     ...
     * @exception org.apache.lucene.queryparser.classic.ParseException throw in overridden method to disallow
     */
    protected Query getPrefixQuery(String field, String termStr) throws org.apache.lucene.queryparser.classic.ParseException
    {
        if (!allowLeadingWildcard && termStr.startsWith("*"))
            throw new org.apache.lucene.queryparser.classic.ParseException("'*' not allowed as first character in PrefixQuery");
        BytesRef term = getAnalyzer().normalize(field, termStr);
        Term t = new Term(field, term);
     ...
     * @exception org.apache.lucene.queryparser.classic.ParseException throw in overridden method to disallow
     */
    protected Query getFuzzyQuery(String field, String termStr, float minSimilarity) throws org.apache.lucene.queryparser.classic.ParseException
    {
        BytesRef term = getAnalyzer().normalize(field, termStr);
        Term t = new Term(field, term);
    ...
    Query handleBareTokenQuery(String qfield, org.apache.lucene.queryparser.classic.Token term, org.apache.lucene.queryparser.classic.Token fuzzySlop, boolean prefix, boolean wildcard, boolean fuzzy, boolean regexp) throws org.apache.lucene.queryparser.classic.ParseException {
        Query q;
    ...
    Query handleBareFuzzy(String qfield, org.apache.lucene.queryparser.classic.Token fuzzySlop, String termImage)
            throws org.apache.lucene.queryparser.classic.ParseException {
        Query q;
        ...
        if(fms < 0.0f){
            throw new org.apache.lucene.queryparser.classic.ParseException("Minimum similarity for a FuzzyQuery has to be between 0.0f and 1.0f !");
        } else if (fms >= 1.0f && fms != (int) fms) {
            throw new org.apache.lucene.queryparser.classic.ParseException("Fractional edit distances are not allowed!");
        }
    ...
    // extracted from the .jj grammar
    Query handleQuotedTerm(String qfield, org.apache.lucene.queryparser.classic.Token term, org.apache.lucene.queryparser.classic.Token fuzzySlop) throws org.apache.lucene.queryparser.classic.ParseException {
     ...
     *
     */
    String discardEscapeChar(String input) throws org.apache.lucene.queryparser.classic.ParseException {
        ...
        if (codePointMultiplier > 0) {
            throw new org.apache.lucene.queryparser.classic.ParseException("Truncated unicode escape sequence.");
        }

        if (lastCharWasEscapeChar) {
            throw new org.apache.lucene.queryparser.classic.ParseException("Term can not end with escape character.");
        }
    ...
    static final int hexToInt(char c) throws org.apache.lucene.queryparser.classic.ParseException {
        if ('0' <= c && c <= '9') {
            return c - '0';
        } else if ('a' <= c && c <= 'f'){
            return c - 'a' + 10;
