package org.xbib.elasticsearch.query.decompound;
...
public class DecompoundQueryTests extends ESIntegTestCase {
    ...
    public void setup() throws Exception {
        String indexBody = StreamsUtils.copyToStringFromClasspath("/org/xbib/elasticsearch/query/decompound/decompound_query.json");
